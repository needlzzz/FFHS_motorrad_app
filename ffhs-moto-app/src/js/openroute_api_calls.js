...
async function asyncAPIandBackendCall() {
  try {
    ...
    const reponse1 = await fetchDataFromAPI(URL);
...
export { mapboxAccessToken, baseURL, asyncAPIandBackendCall, APIresponse };
